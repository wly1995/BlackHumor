package com.atguigu.blackhumor.ui.view;
...
import com.atguigu.blackhumor.utils.BitmapUtil;
...
public class MyProgressBar extends View {
    ...
    public MyProgressBar(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            progressWidth = array.getDimension(R.styleable.progress_progressWidth, BitmapUtil.dip2px(context,8));
            textSize = array.getDimension(R.styleable.progress_textSize, BitmapUtil.dip2px(context,16));
            array.recycle();
        } else {
            bgColor = Color.GRAY;
            srcColor = Color.RED;
            ...
            sweepArc = 0;
            progressWidth = BitmapUtil.dip2px(context,8);
            textSize = BitmapUtil.dip2px(context,16);
        }
